    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Icon type="feather" name="edit-2" size={16} color="#F8F8F8" />
          </TouchableHighlight>
        </Animated.View>
        <Animated.View
          style={{
        ...
        >
          ...
          >
            <Icon type="feather" name="home" size={16} color="#F8F8F8" />
          </TouchableHighlight>
        </Animated.View>
        <Animated.View
          style={{
        ...
        >
          ...
          >
            <Icon type="feather" name="archive" size={16} color="#F8F8F8" />
          </TouchableHighlight>
        </Animated.View>
        <TouchableHighlight
        ...
        >
          ...
          >
            <Icon type="feather" name="plus" size={24} color="#F8F8F8" />
          </Animated.View>
        </TouchableHighlight>
      </View>
    );
